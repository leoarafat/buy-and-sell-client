        ...
        <div class="mt-12 grid items-center gap-6 md:grid-cols-2 lg:flex lg:space-x-8">
          <div class="group relative md:col-span-1 lg:w-[32%]">
            ...
            <div class="relative space-y-8 p-8">
              ...
              <div class="relative flex justify-around">
                <div class="flex">
                  <span class="-ml-6 mt-2 text-3xl font-bold text-primary">
                    $
                  </span>
                  <span class="leading-0 text-8xl font-bold text-gray-800 dark:text-white">
                    19
                  </span>
                </div>
              ...
              <ul class="m-auto w-max space-y-4 pb-6 text-gray-600 dark:text-gray-300">
                <li class="space-x-2">
            ...
            <div class="relative space-y-8 p-8">
              ...
              <div class="overflow-hidden">
                <div class="-mr-20 flex items-end justify-center">
                  ...
                  <div class="mb-2">
                    <span class="block text-xl font-bold text-gray-500 dark:text-gray-400">
                      .56
                    </span>
                ...
                <span class="block text-center text-xs uppercase text-primary">
                  BILLED YEARLY
                </span>
          ...
          <div class="group relative md:col-span-1 lg:w-[32%]">
            ...
            <div class="relative space-y-8 p-8">
              ...
              <div class="relative flex justify-around">
                <div class="flex">
                  <span class="-ml-2 mt-2 text-3xl font-bold text-primary">
                    $
                  </span>
                  <span class="leading-0 text-8xl font-bold text-gray-800 dark:text-white">
                    0
